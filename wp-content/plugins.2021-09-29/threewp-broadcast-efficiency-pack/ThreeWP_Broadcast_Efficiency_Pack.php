...
Description:	Broadcast more efficiently while you do more important things.
Plugin Name:	Broadcast Efficiency Pack
Plugin URI:		https://broadcast.plainviewplugins.com
Version:		47.08
*/

define( 'BROADCAST_EFFICIENCY_PACK_VERSION', 47.08 );

/**
	@brief		This class handles the loading of the pack.
	@since		2015-10-29 15:37:13
**/
class threewp_broadcast_efficiency_pack_loader
{
	/**
	...
	**/
	public function pack()
	{
		if ( $this->plugin_pack === false )
		{
			...
			new \threewp_broadcast\premium_pack\ThreeWP_Broadcast_Efficiency_Pack();
		}
		return $this->plugin_pack;
	}
}

new threewp_broadcast_efficiency_pack_loader();
