...
class WelcomePage {
    ...
    public function activated_plugin($plugin) {
        ...
        if (!$fromBulkAction && !$isWpCli && $plugin === plugin_basename($this->getInitiator()->getPluginFile())) {
            $redirectState = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::get(
                $this->getInitiator(),
                \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_REDIRECT_AFTER_ACTIVATE,
                \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_REDIRECT_AFTER_ACTIVATE_NOT_REGISTERED
            );
            if (
                $redirectState ===
                \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_REDIRECT_AFTER_ACTIVATE_NOT_REGISTERED
                ...
                \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::set(
                    $this->getInitiator(),
                    \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_REDIRECT_AFTER_ACTIVATE,
                    \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_REDIRECT_AFTER_ACTIVATE_AWAITING_REDIRECT
                );
            }
        }
    }
        ...
        if (
            ...
            if (
                ...
                \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::set(
                    $this->getInitiator(),
                    \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_REDIRECT_AFTER_ACTIVATE,
                    \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_REDIRECT_AFTER_ACTIVATE_REDIRECTED
                );
