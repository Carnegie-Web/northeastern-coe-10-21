...
final class WDFM {
  ...
  private function define_constants() {
    ...
    $this->plugin_version = '1.14.0';
    $this->db_version = '2.14.0';
  ...
  public function check_alter_table_privilege() {
    ...
    if ( get_option('fm_alter_table_privilege', '0') == '0' ) {
      if ( $this->is_free == 2 ) {
    ...
    if ( get_option('fm_alter_table_notice', '0') == '1' && get_option('fm_alter_table_privilege', '0') == '0' ) {
    ...
    switch ( $event->type ) {
      case 'charge.captured':
        ...
        if ( $endpoint_object->captured ) {
          ...
          $model->update_stripe_status($group_id);
        }
        break;
      default:
